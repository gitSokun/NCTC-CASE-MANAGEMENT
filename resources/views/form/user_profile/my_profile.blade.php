...
<div class="container-fluid">
	<div class="row">
		<!-- /.col -->
		<div class="col-md-9">
			<form class="form-horizontal" id="newStaff" method="POST" action="{{ route('my-profile-update') }}">
				{{ csrf_field() }}
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" id="skill" name="skill" placeholder="ជំនាញ"
									>{{$userProfile->skill}}</textarea>
							</div>
						</div>
						<div class="form-group row">
